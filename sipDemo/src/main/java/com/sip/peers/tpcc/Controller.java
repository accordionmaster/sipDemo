...
public class Controller implements SipListener {
    ...
    String ASipAddressDomain = "192.168.200.1:62351";

    String ADisplayName = "The A first";

    String Buser = "some";

    String BSipAddressDomain = "192.168.200.1:57572";

    String BDisplayName = "The B second";

    String peerHostPortA = "192.168.200.1:62351";

    String peerHostPortB = "192.168.200.1:64894";
    ...
    public Request createInvite(String headerName, String headerValue,
        ...
        ViaHeader viaHeader = headerFactory.createViaHeader("192.168.200.1",
    ...
    public void init() {
        ...
        try {
            ...
            udpListeningPoint = sipStack.createListeningPoint("192.168.200.1",
                    8082, "udp");
        ...
        try {
            ...
            Request request = this.createInvite(Secuencia, String
                    .valueOf(first), UUID.randomUUID().toString(), null, peerHostPortA);
